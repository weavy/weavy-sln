    ...
    TagsInput.prototype = {
        ...
        remove: function (item, dontPushVal, options) {
            ...
            if (item) {
                ...
                $('option', self.$element).filter(function () { return $(this).data('item') === item || $(this).attr("data-item") === item; }).remove();
        ...
        pushVal: function () {
            ...
            if (self.isSelect) {
                ...
                if (val.length === 0) {
                    // add empty hidden input to allow the tags to be cleared serverside
                    self.$container.append("<input type='hidden' name='" + name + "' value='' id='empty_" + name + "' />");
                } else {
                    $("#empty_" + name).remove();
                }
            }
