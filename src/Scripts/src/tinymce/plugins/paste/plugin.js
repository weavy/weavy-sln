...
(function (exports, undefined) {
                    ...
                    if (items) {                        
                        ...
                        if (imageDataOnly) {
                            for (i = 0; i < items.length; i++) {
                                ...
                                if (editor.settings.upload_paste_data_images) {
                                    ...
                                    $.ajax({
                                        ...
                                        xhr: function () {
                                            ...
                                            xhr.upload.addEventListener("progress", function (evt) {
                                                if (evt.lengthComputable) {
                                                    ...
                                                    $("body").children(".progress").css("width", parseInt(percentComplete, 10) + "%").show();
                                                }
                                            }, false);
                                        ...
                                        complete: function () {
                                            // reset progress bar
                                            $("body").children(".progress").css("width", "0%").hide();
                                        }
                                    });
    ...
    define("tinymce/pasteplugin/Plugin", [
        ...
        PluginManager.add('weavy_paste', function (editor) {
